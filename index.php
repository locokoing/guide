...
<html lang="zh-CN">
 <head> 
  ...
  <!--QQ应用模式--> 
  <title>locoko导航</title> 
  <meta name="keywords" content="locoko导航,locoko搜索,locoko搜索导航,locoko,locoko工具,locoko短网址,locoko图床,locoko在线ps,locoko图床工具,locoko音乐，locoko博客">
 ...
 <body> 
  ...
  <div class="list closed"> 
   <ul>
    ...
    <li><a rel="nofollow" href="https://yesme.top/" target="_blank"><i class="iconfont icon-kologom" style="color: #f03;"></i>locoko博客</a></li> 
    <li><a rel="nofollow" href="http://livepopo.ys168.com/" target="_blank"><i class="iconfont icon-tupian" style="color: #f90;"></i>川物间</a></li> 
    <li><a rel="nofollow" href="https://livepopo.github.io/" target="_blank"><i class="iconfont icon-p" style="color: #fff;"></i>locoko微航</a></li> 
    <li><a rel="nofollow" href="https://github.com/" target="_blank"><i class="iconfont icon-Qyouhuiquan" style="color: #2196f3;"></i>Github</a></li> 
    <li><a rel="nofollow" href="https://gitee.com/" target="_blank"><i class="iconfont icon-fuzhilianjiexian-" style="color: #f05;"></i>Gitee</a></li>
    <!----> 
  ...
  <div id="search" class="s-search">
   <div id="search-list" class="hide-type-list">
    ...
    <div class="search-group group-a">
     ...
     <li><input onclick="bw()" checked="" hidden="" type="radio" name="type" id="type-bing" value="https://cn.bing.com/search?q=" data-placeholder="Bing搜索" /><label for="type-bing"><span>Bing</span></label></li>
      ...
      <li><input onclick="bw()" hidden="" type="radio" name="type" id="type-baidu" value="https://www.baidu.com/s?wd=" data-placeholder="百度一下" /><label for="type-baidu"><span>百度</span></label></li>
     </ul>
    </div>
  ...
  <div class="bgo"></div> 
  <a href='https://www.landui.com' target='_blank'>服务器提供商：蓝队云</a>
  </body>
  </html>
